  ...
  return (
	...
	<div className="relative py-3 sm:max-w-xl sm:mx-auto">
		...
		<div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <p>If You Dont Have An Account. Please <Link to="/sign-up" className='text-blue-600'>Sign Up</Link> </p>
						<div className="relative">
        ...
        <hr/>
        <div className='flex w-full items-center flex-col gap-3 mt-5'>
          <button className='block' onClick={handleRegister}> <img src={googleLogo} alt="" className='w-12 h-12 inline-block' />
            Login With Google
          </button>
        </div>
			</div>
