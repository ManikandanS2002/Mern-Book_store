  ...
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between'>
      ...
      <div className='md:w-1/2 space-y-6'>
         <h2 className='text-5xl font-bold my-5 md:w-3/4 leading-snug '>Find Your Favourite<br/>
         <span className='text-blue-700'>Book Here!</span> </h2>
         <p className='mb-10 text-xl md:w-5/6 space-y-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro debitis culpa commodi quod nostrum, 
           blanditiis veritatis dolores recusandae! Voluptate, placeat! Error est repudiandae maxime blanditiis.</p>
         {/* Stats */}
